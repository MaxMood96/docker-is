...
based Docker image for WSO2 Identity Server `7.3.0`.
...
+ `docker build -t wso2is:7.3.0 --build-arg USER_ID=<UID> --build-arg USER_GROUP_ID=<GID> .`

##### 3. Running the Docker image.

- `docker run -it -p 9443:9443 wso2is:7.3.0`
