...
based Docker image for WSO2 Identity Server `7.3.0` with [Post-Quantum TLS support](https://is.docs.wso2.com/en/7.1.0/deploy/security/configure-post-quantum-tls/).
...
- Navigate to `<IS_DOCKERFILE_HOME>` directory. <br>
  Execute `docker build` command as shown below.
    + `docker build -t wso2is:7.3.0-pqc .`
...
+ `docker build -t wso2is:7.3.0-pqc --build-arg USER_ID=<UID> --build-arg USER_GROUP_ID=<GID> .`

##### 3. Running the Docker image.

- `docker run -it -p 9443:9443 wso2is:7.3.0-pqc`
