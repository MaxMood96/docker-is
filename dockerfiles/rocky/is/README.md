...
This section defines the step-by-step instructions to build an [Rocky Linux](https://hub.docker.com/_/rockylinux) Linux based Docker image for WSO2 Identity Server `7.3.0`.
...
- Navigate to `<IS_DOCKERFILE_HOME>` directory. <br>
  Execute `docker build` command as shown below.
    + `docker build -t wso2is:7.3.0-rocky .`

> Configure the URL of hosted wso2is-7.3.0 distribution as WSO2_SERVER_DIST_URL.
...
+ `docker build -t wso2is:7.3.0-rocky --build-arg USER_ID=<UID> --build-arg USER_GROUP_ID=<GID> .`

##### 3. Running the Docker image.

- `docker run -it -p 9443:9443 wso2is:7.3.0-rocky`
...
In WSO2 Identity Server version `7.3.0` product distribution, `deployment.toml` configuration file <br>
...
>In here, <TARGET_CONFIGS> refers to /home/wso2carbon/wso2is-7.3.0/repository/conf folder of the container.
