...
DROP DATABASE IF EXISTS WSO2IS_AGENTIDENTITY_DB;
CREATE DATABASE WSO2IS_AGENTIDENTITY_DB;
...
CREATE USER IF NOT EXISTS 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL PRIVILEGES ON WSO2IS_AGENTIDENTITY_DB.* TO 'wso2carbon'@'%';
FLUSH PRIVILEGES;
...
-- ------------------- WSO2IS_AGENTIDENTITY_DB TABLES ---------------------

USE WSO2IS_AGENTIDENTITY_DB;
